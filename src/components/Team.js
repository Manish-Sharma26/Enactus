        ...
        {displayedTeamMembers.map(({ node }) => (
          ...
          >
            <img
              src={node.image.url}
              alt={node.name}
              className="w-full h-[400px] object-cover rounded-t-lg bg-black transition-transform duration-300"
            />
            <div className="p-4 gap-3 flex items-center justify-center flex-col absolute bottom-0 left-0 right-0 bg-white bg-opacity-90 backdrop-filter backdrop-blur-md">
